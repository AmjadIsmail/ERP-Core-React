    ...
    FilterFn()
    {
        ...
        var filterData=this.state.ListWithoutFilter.filter(
            function(el){
                ...
                el.MonthName.toString().trim().toLowerCase().includes(
                    NameFilter.toString().trim().toLowerCase()
                )
                &&
                el.FromDate.toString().trim().toLowerCase().includes(
                    FromDateFilter.toString().trim().toLowerCase()
                )
                &&
                el.ToDate.toString().trim().toLowerCase().includes(
                    ToDateFilter.toString().trim().toLowerCase()
                )
               /* &&
                el.IsActive.toString().trim().toLowerCase().includes(
